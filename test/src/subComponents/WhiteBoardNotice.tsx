 ...
 *
 */
function WhiteBoardNotice({uid}: {uid: UidType}) {
    //commented for v1 release
    // const screensharingActiveOverlayLabel = useString(
    //   'screensharingActiveOverlayLabel',
    // )();
    const whiteboardActiveOverlayLabel = 'Your screen share is active.';
    const {rtcProps} = useContext(PropsContext);
    return uid === rtcProps?.WhiteBoardUid ? (
...
export default WhiteBoardNotice;
